...
classifier_name = st.sidebar.selectbox("Select clasifier to run prediction", ("Classifier",
                                                                              "Naive Bayes", 
                                                                              "K-Nearest Neighbour",
                                                                              "Decision Tree",
                                                                              "Random Forest",
...
st.write("""
# Deployment
-  Arissa Izzati binti Azraf (1171101753)  
-  Hani Karmisah binti Mohd Noor (1171101716)
-  Afra Nazinin Binti Pasla Sukkur Ahamed Zahir Hussain (1171101709)
""")
...
if st.checkbox("Show Columns"):
	...
	# Show Columns
if st.checkbox("Show Columns with Data_Types"):
	st.write(df2.dtypes)        
...
if st.checkbox('Bar Chart'):  
    feature = st.selectbox('Choose a column to show Bar Chart', df2.columns[0:23])
    #st.bar_chart(df2[feature])
    df2[feature].value_counts(normalize=True).plot.bar(title=feature)
    st.pyplot()
...
if st.checkbox("Pie Chart"):
	...
	pie_plot = df2[columns_to_plot].value_counts().plot.pie(autopct="%1.1f%%")
	st.write(pie_plot)
	st.pyplot()
    
# Missing Value Plot    
# =============================================================================
# if st.checkbox("Plot Heatmap", key=0):
#     heat = msno.matrix(df)
#     st.write(heat)
#     st.pyplot()
# =============================================================================
...
if st.checkbox('Show Bottom Features'):
